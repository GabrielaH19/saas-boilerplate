...
const CARD_TEXT: Record<string, any> = {
  ro: { badge: "Calculator profit curse TIR", profitNet: "PROFIT NET", profitKm: "PROFIT / KM", km: "KILOMETRI", accept: "ACCEPTA", acceptSub: "Cursa profitabila. Merita acceptata.", negotiate: "NEGOCIAZA", negotiateSub: "Profit mic. Incearca sa negociezi.", reject: "REFUZA", rejectSub: "Nu merita. Costurile depasesc beneficiul.", footer: "tripprofit.ro - Calculatorul de profit pentru soferi de TIR din Europa", cta: "Incearca gratuit", title: "Cardul tau de cursa - posteaza-l pe Facebook sau WhatsApp", earn: "Castiga 3 euro pentru fiecare prieten invitat", earnSub: "Posteaza cardul pe grupurile de Facebook pentru soferi. Cand un prieten se aboneaza la Pro prin link-ul tau, primesti 3 euro direct in cont.", refLink: "Vezi link-ul tau de referral", newTrip: "+ Cursa noua", download: "Descarca imaginea" },
  it: { badge: "Calcolatore profitto viaggi TIR", profitNet: "PROFITTO NETTO", profitKm: "PROFITTO / KM", km: "CHILOMETRI", accept: "ACCETTA", acceptSub: "Viaggio redditizio. Vale la pena.", negotiate: "NEGOZIA", negotiateSub: "Margine basso. Negozia.", reject: "RIFIUTA", rejectSub: "Non vale. I costi superano il ricavo.", footer: "tripprofit.ro - Calcolatore di profitto per camionisti in Europa", cta: "Prova gratis", title: "La tua scheda viaggio - condividila su Facebook o WhatsApp", earn: "Guadagna 3 euro per ogni amico invitato", earnSub: "Posta la scheda nei gruppi Facebook per autisti. Quando un amico si abbona a Pro tramite il tuo link, ricevi 3 euro.", refLink: "Vedi il tuo link referral", newTrip: "+ Nuovo viaggio", download: "Scarica immagine" },
};
